...
public class NotificationUtils {
    ...
    public void showNotificationMessage(String title, String message, Intent intent) {
        ...
        if (isAppIsInBackground(mContext)) {
            // notification icon
            int icon = R.drawable.headerlogo;

            int smallIcon = R.drawable.headerlogo;
            ...
            NotificationCompat.InboxStyle inboxStyle = new NotificationCompat.InboxStyle().setBigContentTitle(message);
